...
// ============================================================================
// � FASE ADICIONAL: REVISÃO E APERFEIÇOAMENTO DA INTERFACE WEB
// ============================================================================
...
const FASE_REVISAO_INTERFACE = {
    ...
    fase_revisao_interface: {
        titulo: "🔧 AUDITORIA E CORREÇÃO DA INTERFACE WEB",
        ...
        tarefa_rev_1: {
            ...
            prompt_detalhado: `
            PROMPT: "Faça auditoria completa da interface web:
            1. Teste todas as rotas: /, /ensembl-genes, /ema-medicines, /eu-trials, /who-data
            2. Identifique dados mockados vs dados reais em cada página
            3. Verifique se estatísticas laterais correspondem aos dados reais
            4. Confirme se paginação funciona corretamente
            5. Teste links de navegação entre páginas
            6. Valide se contadores do dashboard são reais
            Meta: Lista completa de problemas para correção"
            `,
            arquivos_envolvidos: [
                ...
                "views/eu-trials.ejs", 
                "views/who-data.ejs",
                "views/uniprot-proteins.ejs",
                "views/gene-expression.ejs"
            ],
            validacao: "Todas as páginas mostram dados 100% reais do banco SQLite"
        },
        ...
        tarefa_rev_2: {
            ...
            prompt_detalhado: `
            PROMPT: "Corrija todas as inconsistências encontradas:
            1. Substitua dados mockados por queries reais ao banco
            2. Corrija nomes de colunas incorretos nos templates
            3. Ajuste estatísticas para refletir dados reais
            4. Garanta que filtros e agrupamentos funcionem
            5. Teste navegação completa entre todas as páginas
            6. Valide que contadores dinâmicos são precisos
            Meta: Interface 100% funcional com dados reais"
            `,
            dependencias: ["REV.1"],
            resultado_esperado: "Interface web totalmente funcional e fidedigna"
        },
        ...
        tarefa_rev_3: {
            ...
            prompt_detalhado: `
            PROMPT: "Teste completo da interface corrigida:
            1. Navegue por todas as páginas sistematicamente
            2. Verifique se todos os números são reais e corretos
            3. Teste funcionalidades: paginação, filtros, busca
            4. Confirme que dados mostrados correspondem ao banco
            5. Valide estatísticas laterais e contadores
            6. Teste em diferentes tamanhos de tela
            Meta: Interface aprovada pelo usuário"
            `,
            dependencias: ["REV.2"],
            criterios_aceitacao: [
                "Todos os dados mostrados são reais do banco SQLite",
                "Estatísticas corretas: 50K genes, 8K medicamentos, 15K ensaios, etc.",
    ...
    melhorias_futuras: {
        titulo: "🚀 MELHORIAS FUTURAS DA INTERFACE",
        prioridade: "MÉDIA - Após correções básicas",
        
        funcionalidades_avancadas: [
            "Sistema de busca global por genes, medicamentos, ensaios",
            "Filtros avançados por país, área terapêutica, fase", 
            "Gráficos interativos com estatísticas temporais",
            "Exportação de dados em CSV/Excel",
            "API REST documentada para desenvolvedores",
            "Dashboard administrativo para monitoramento",
            "Sistema de alertas para novos dados",
            "Integração com ferramentas de visualização"
        ],
        
        apis_rest: [
            "GET /api/genes?search=BRCA1&limit=50",
            "GET /api/medicines?therapeutic_area=oncology", 
            "GET /api/trials?phase=III&country=Portugal",
            "GET /api/statistics/summary",
            "GET /api/export/genes?format=csv"
        ]
    },
...
💡 PRÓXIMO PASSO:
   Iniciar FASE REVISÃO INTERFACE - Corrigir dados mockados para 100% reais
`);
