...
class SchemaImplementation {
    ...
    async generatePrismaClient() {
        try {
            ...
            // Usar spawn para executar npx prisma generate
        ...
        try {
            ...
            for (const table of genomicTables) {
                try {
                    ...
                    // (Aqui faríamos insert de teste, mas por segurança vamos só verificar a estrutura)
...
export default SchemaImplementation;
